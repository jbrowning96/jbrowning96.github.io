...
![alt text](/assets/images/annie-spratt-r0vBUseBuYQ-unsplash.jpg)
...
I am now testing the functionality of mathjax inline: $y=x^2$.

I am now testing the functionality of mathjax displayed style
\\[y = x^2.\\]

In fact, we can do any of the things we'd ordinarily do using markdown.